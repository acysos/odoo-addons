    ...
    def action_produce_assign_service(self, cr, uid, ids, context={}):
        for procurement in self.browse(cr, uid, ids):
            ...
            for line in sline.browse(cr, uid, sale_ids, context=context):
                ...
                workorder_id = line.order_id.workorder_id.id
                vehicle_id = line.order_id.vehicle_id.id
            ...
            if  not proj_exist_id:
                project_id = self.pool.get('project.project').create(cr, uid, {'name':proj_name,'category_id':analytic_account_id, 'partner_id':partner_id, 'workorder_id':workorder_id, 'vehicle_id':vehicle_id})
            else:

...
<tr><td>
    <para style="nospace"><xsl:value-of select="object.code"/></para>
</td><td>
    <para style="nospace"><xsl:value-of select="object.lst_price"/><xsl:text> €</xsl:text></para>
</td></tr><tr><td>
<barCode><xsl:value-of select="object.code"/></barCode>
</td><td>
    <para style="nospace"><xsl:value-of select="object.name_template"/></para>
</td></tr>
</blockTable>
<nextFrame/>
</xsl:template>

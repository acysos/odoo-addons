...
class PaymentMode(models.Model):
    ...
    is_csb68 = fields.Boolean(compute="_compute_is_csb68")

    @api.multi
    @api.depends('type')
    def _compute_is_csb19(self):
        csb19_type = self.env.ref('l10n_es_payment_order_banking.export_csb19')
        for record in self:
    ...
    def _compute_is_csb32(self):
        csb32_type = self.env.ref('l10n_es_payment_order_banking.export_csb32')
        for record in self:
    ...
    def _compute_is_csb34(self):
        csb34_type = self.env.ref('l10n_es_payment_order_banking.export_csb34')
        for record in self:
    ...
    def _compute_is_csb3401(self):
        csb3401_type = self.env.ref('l10n_es_payment_order_banking.export_csb34_01')
        for record in self:
    ...
    def _compute_is_csb58(self):
        csb58_type = self.env.ref('l10n_es_payment_order_banking.export_csb58')
        for record in self:
            record.is_csb58 = record.type == csb58_type

    @api.multi
    @api.depends('type')
    def _compute_is_csb68(self):
        csb68_type = self.env.ref('l10n_es_payment_order_banking.export_csb68')
        for record in self:
            record.is_csb68 = record.type == csb68_type

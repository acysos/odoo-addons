...
class banking_export_pain(orm.AbstractModel):
    ...
    def generate_remittance_info_block(
            self, cr, uid, parent_node, line, communication_str, gen_args, context=None):
        ...
        if line.state == 'normal':
            ...
            creditor_reference_2_126.text = \
                self._prepare_field(
                    ...
                    communication_str, {'line': line}, 35,
                    gen_args=gen_args,
                    context=context)
        return True

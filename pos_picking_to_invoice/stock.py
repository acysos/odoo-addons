...
class stock_picking(osv.osv):
    ...
    _columns = {
        'pos_id': fields.many2one('pos.order', 'POS Order', ondelete='set null', select=True),
        }
    ...
    def _prepare_invoice_line(self, cr, uid, group, picking, move_line, 
        ...
        if move_line.pos_line_id:
            ...
            res['discount'] = move_line.pos_line_id.discount
        return res
...
class stock_move(osv.osv):
    ...
    _columns = {
            'negative':fields.boolean('Negative', required=False),

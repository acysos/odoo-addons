...
class real_state_top(models.Model):
    ...
    def xml_idealista(self):
         ...
         aggregator.text = 'ba65b2dd4213254b63e3a9d058e98bec13c54a16'
         code = etree.SubElement(cliente, 'code')
         code.text = 'ilc9878eaa3a032b99242a44e87eca298f8853978c4'
         contact = etree.SubElement(cliente, 'contact')
         name = etree.SubElement(contact, 'name')
         name.text = 'Inmobiliaria Urbasa'

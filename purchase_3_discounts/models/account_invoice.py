...
class AccountInvoice(models.Model):
    ...
    def _prepare_invoice_line_from_po_line(self, line):
        res = super(AccountInvoice, self)._prepare_invoice_line_from_po_line(
            line)
        discount1 = line.discount1 or 0.0
        discount2 = line.discount2 or 0.0
        discount3 = line.discount3 or 0.0
        res['discount1'] = discount1
        res['discount2'] = discount2
        res['discount3'] = discount3
        res['discount'] = 100 * (1 - ((100 - discount1) / 100.00 * (
